...
public class EncriptacionURL {
	...
	public static String encode(String input) {
		...
		try {
			...
			String res = new String(Base64.encodeBase64( ecipher.doFinal(input.getBytes()) ));
			// escapes for url
	...
	public static String decode(String token) {
		...
		try {
			...
			return new String( dcipher.doFinal( Base64.decodeBase64(input.getBytes()) ) );
		} catch (Exception e) {
			return null;
		}
	}
